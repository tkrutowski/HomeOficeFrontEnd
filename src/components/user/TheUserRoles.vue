  ...
  methods: {
    ...
    updatePrivilegeToUserRoleDB(userID, roleID, privileges) {
      ...
      axios
        ...
        .then(() => this.displaySmallMessage("success", "Zapisano uprawnienia dla roli."))
        .catch((e) => {
          this.errors.push(e);
          this.validateError(e);
        });
    ...
    addRoleToUserDB(userID, roleID) {
      ...
      axios
        ...
        .then(() => this.displaySmallMessage("success", "Dodano rolę do użytkownika."))
        .catch((e) => {
          this.validateError(e);
        });
    },
